...
function MasterItemPage() {
  ...
  async function getData() {
    try {
      ...
      var res = await masterService.getItem(query);
  ...
  async function onCreate(data) {
    try {
      ...
      var res = await masterService.postItemCreate(data);
  ...
  async function onUpdate(data) {
    try {
      setIsSubmittingData(true);
      var res = await masterService.postItemUpdate(data);
      setIsSubmittingData(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
  ...
  async function onDelete(data) {
    try {
      setIsLoading(true);
      var res = await masterService.deleteItem(data);
      setIsLoading(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
