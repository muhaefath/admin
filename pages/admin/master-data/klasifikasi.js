...
const page = "Klasifikasi";

function MasterKlasifikasiPage() {
  ...
  async function getData() {
    try {
      ...
      var res = await masterService.getKlasifikasi(query);
  ...
  async function onCreate(data) {
    try {
      ...
      var res = await masterService.postKlasifikasiCreate(data);
  ...
  async function onUpdate(data) {
    try {
      setIsSubmittingData(true);
      var res = await masterService.postKlasifikasiUpdate(data);
      setIsSubmittingData(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
  ...
  async function onDelete(data) {
    try {
      setIsLoading(true);
      var res = await masterService.deleteKlasifikasi(data);
      setIsLoading(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
...
MasterKlasifikasiPage.layout = Admin;

export default MasterKlasifikasiPage;
