...
const page = "Pengguna Jasa";

function MasterPenggunaJasaPage() {
  ...
  async function getData() {
    try {
      ...
      var res = await masterService.getPenggunaJasa(query);
  ...
  async function onCreate(data) {
    try {
      ...
      var res = await masterService.postPenggunaJasaCreate(data);
  ...
  async function onUpdate(data) {
    try {
      setIsSubmittingData(true);
      var res = await masterService.postPenggunaJasaUpdate(data);
      setIsSubmittingData(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
  ...
  async function onDelete(data) {
    try {
      setIsLoading(true);
      var res = await masterService.deletePenggunaJasa(data);
      setIsLoading(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
  ...
  return (
    <div>
      ...
      >
        ...
        <Column sortable field="contact_name" header="Contact Name"></Column>
        <Column sortable field="phone" header="Phone"></Column>
        <Column sortable field="unit_name" header="Unit Name"></Column>
        <Column
          header=""
          style={{ width: "150px" }}
          // className={
          ...
          <Modal.Body style={{ maxHeight: "500px", overflow: "auto" }}>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control
                ...
                onChange={(e) => {
                  ...
                  tmpSelectedItem.contact_name = e.target.value;
                  setEditItem(tmpSelectedItem);
                }}
              />
              <Form.Control.Feedback type="invalid">
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control
                autoComplete="off"
                disabled={editItem.user_view == 1 ? true : false}
                value={editItem.unit_name}
                required
                onChange={(e) => {
                  let tmpSelectedItem = {
                    ...editItem,
                  };
                  tmpSelectedItem.unit_name = e.target.value;
                  setEditItem(tmpSelectedItem);
                }}
              />
              <Form.Control.Feedback type="invalid">
...
MasterPenggunaJasaPage.layout = Admin;

export default MasterPenggunaJasaPage;
