...
function MasterPriorityPage() {
  ...
  async function getData() {
    try {
      ...
      var res = await masterService.getPriority(query);
  ...
  async function onCreate(data) {
    try {
      ...
      var res = await masterService.postPriorityCreate(data);
  ...
  async function onUpdate(data) {
    try {
      setIsSubmittingData(true);
      var res = await masterService.postPriorityUpdate(data);
      setIsSubmittingData(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
  ...
  async function onDelete(data) {
    try {
      setIsLoading(true);
      var res = await masterService.deletePriority(data);
      setIsLoading(false);
      if (res.status == "ok") {
        addError("Informasi", res.pesan, stat.success);
        getData();
...
MasterPriorityPage.layout = Admin;

export default MasterPriorityPage;
